...
class ContoursOptions: public tMessage
{
public:
	int Treshold;

	ContoursOptions(): tMessage()
	{
		Treshold= 0;
	}

	ContoursOptions(ContoursOptions* copy): tMessage()
	{
		Treshold= copy->Treshold;
	}

	virtual tMessage *copy()
	{
		ContoursOptions *tContoursOptions= new ContoursOptions(((ContoursOptions*)this));
		return (tMessage*)tContoursOptions;
	}
};
...
public:
	...
	IplImage* Process( IplImage *InputFrame );
